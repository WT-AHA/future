package com.aha.common.design.patterns.adapter;
    ...
    protected void doDispatch(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            try {
                ...
                // 适配器模式主要看此方法
                // 使用适配的主要原因是因为 处理器 handler: HandlerFunction HttpRequestHandler Controller
                // 没有继承或者实现统一的接口，所以没有统一的 handle 方法，所以包装了一层
                // HandlerFunctionAdapter HttpRequestHandlerAdapter SimpleControllerHandlerAdapter
                // 然后 统一实现 HandlerAdapter 提供统一的 handle 方法
                // 来实现适配器模式 (与策略模式的区别也在这里，二者结合使用)
