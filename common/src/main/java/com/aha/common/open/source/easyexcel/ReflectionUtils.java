...
public class ReflectionUtils {
    ...
    /**
     * Pre-built {@link org.springframework.util.ReflectionUtils.MethodFilter} that matches all non-bridge non-synthetic methods
     ...
     * @throws IllegalStateException if introspection fails
     */
    public static void doWithMethods(Class<?> clazz, org.springframework.util.ReflectionUtils.MethodCallback mc, @Nullable org.springframework.util.ReflectionUtils.MethodFilter mf) {
     ...
     * @since 5.2
     */
    public static Method[] getUniqueDeclaredMethods(Class<?> leafClass, @Nullable org.springframework.util.ReflectionUtils.MethodFilter mf) {
        final List<Method> methods = new ArrayList<>(20);
     ...
     * @throws IllegalStateException if introspection fails
     */
    public static void doWithFields(Class<?> clazz, org.springframework.util.ReflectionUtils.FieldCallback fc, @Nullable org.springframework.util.ReflectionUtils.FieldFilter ff) {
        // Keep backing up the inheritance hierarchy.
    ...
    public interface MethodFilter {
         ...
         * @since 5.3.2
         */
        default org.springframework.util.ReflectionUtils.MethodFilter and(org.springframework.util.ReflectionUtils.MethodFilter next) {
    ...
    public interface FieldFilter {
         ...
         * @since 5.3.2
         */
        default org.springframework.util.ReflectionUtils.FieldFilter and(org.springframework.util.ReflectionUtils.FieldFilter next) {
